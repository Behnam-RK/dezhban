...
const completionCommands = "run block unblock status validate monitor print-rules doctor panic install uninstall start stop detect-vpn setup config completion version help"
