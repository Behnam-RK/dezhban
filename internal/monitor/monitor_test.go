...
func TestProviderParsers(t *testing.T) {
	cases := []struct {
		...
		{"ip-country (geojs/country.is)", parseIPCountry, `{"ip":"9.9.9.9","country":"kz"}`, "9.9.9.9", "KZ", false},
		{"ip-country v6", parseIPCountry, `{"ip":"2a03:90c0:3e9:1::2f6","country":"KZ"}`, "2a03:90c0:3e9:1::2f6", "KZ", false},
		{"ipwho.is ok", parseIPWhois, `{"ip":"9.9.9.9","country_code":"KZ","success":true}`, "9.9.9.9", "KZ", false},
		{"ipwho.is failure", parseIPWhois, `{"success":false,"message":"rate limit"}`, "", "", true},
		{"ipwho.is missing success", parseIPWhois, `{"ip":"9.9.9.9","country_code":"KZ"}`, "", "", true},
		{"freeipapi", parseFreeIPAPI, `{"ipAddress":"9.9.9.9","countryCode":"KZ"}`, "9.9.9.9", "KZ", false},
		{"ipapi.co ok", parseIPAPICo, `{"ip":"9.9.9.9","country_code":"KZ"}`, "9.9.9.9", "KZ", false},
		{"ipapi.co rate-limited", parseIPAPICo, `{"error":true,"reason":"RateLimited"}`, "", "", true},
